...
function Support() {
  ...
  return (
    <>
    <div className=" main bg-gradient-to-b from-green-800 via-slate-950 to-black">
...
    </div>
      ...
      <div className="text-gray-400 ">Spotify Support</div>
          ...
          <div className="flex gap-x-2">
            ...
            <h1 className="text-white text-2xl pt-6 "><b>Hello,</b></h1>
          </div>
...
<div className=""><img src={arrow} alt="" className="h-10 w-10" /></div>
  ...
  <div className="text-white flex justify-center text-3xl pt-20">
    <h1 >Visit Our Community</h1>

  </div>
  <div className="text-white flex justify-center text-lg pt-6">
